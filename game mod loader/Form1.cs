    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (Directory.Exists(textBox1.Text))
            {
                ...
                MessageBox.Show("Successfully Loaded!", "Mod Loaded", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }
            else 
            {
                MessageBox.Show("This directory does not exist!", "Invalid Directory!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
